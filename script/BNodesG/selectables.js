    ...
    this.rectOpen = function (e) {
        ...
        self.foreach(self.items, function (el) {
            ...
            if (!e[self.options.moreUsing]) {
                ...
                //ADDED BY ME
                arrayOfSelectedNodes = arrayRemove(arrayOfSelectedNodes, el);
                moveSelectedElements.style.display = 'none';
            }
        });
...
var moveSelectedElements = document.querySelector('#moveSelectedElements')
function makeNodeDivsSelectable() {
    new Selectables({
        elements: 'div',//any querySelectorAll, e.g., 'div, path'
        zone: '#nodeCanvas',
        key: 'ctrlKey', // altKey,ctrlKey,metaKey,false
        selectedClass: 'active', // class name to apply to seleted items      
        
        onSelect:function(element){
            arrayOfSelectedNodes.push(element);
            moveSelectedElements.style.display = '';
            console.log(arrayOfSelectedNodes);
        },
        onDeselect:function(element){
            arrayOfSelectedNodes = arrayRemove(arrayOfSelectedNodes, element);
            moveSelectedElements.style.display = 'none';
            console.log(arrayOfSelectedNodes);
        }
    });
