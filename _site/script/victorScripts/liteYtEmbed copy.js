                ...
                try {
                    ...
                    const data = await response.json();
                        ...
                        // Set up video title
                            ...
                            resolve(); // Resolve the promise after all asynchronous operations are complete
                        } catch (error) {
                            console.error(error);
                            resolve(); // Resolve even if there is an error to avoid blocking
                        }
                    }
            // }
...
async function runFunctionsInOrder() {
    await runFirstPartOfCode();
    videoCloneToOtherTabs();
}
